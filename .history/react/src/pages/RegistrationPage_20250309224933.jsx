...
const RegistrationPage = () => {
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      if (
        ...
        alert(
          "Please fill in emergency contact details and upload required documents."
        );
        return false;
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Registration Successful! Your Volunteer ID is: " + response.volunteerId
      );
      navigate("/");
    } catch (error) {
